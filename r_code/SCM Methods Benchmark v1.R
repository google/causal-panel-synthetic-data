...
set.seed(42)
#Function for taking a number of datasets and forming the list of DF
list_of_datasets <- function(data){
...
#
data_list <-list.files("Data/",pattern = "^synthetic.*csv$") %>% paste("Data/",., sep="") %>%
...
gsynth_ife_bootstrapped_abs_att_AB=future_pmap(list(gsynth_ife_AB ),compute_tot_se_jackknife)
#store gap plots
gsynth_ife_bootstrapped_abs_att_AB_plots=future_pmap(list(gsynth_ife_bootstrapped_abs_att_AB,
...
gsynth_ife_abs_metric_byT_AB=future_pmap(list(gsynth_ife_AB, metric_str="both"),compute_avg_metric_per_t)
#compute overall MSE, MAE
gsynth_ife_abs_metric_AB=future_pmap(list(gsynth_ife_AB, metric_str="both"),compute_avg_metric)
#compute "coverage" -- not sure if that's exactly it, but the frac of time the true TE is in the bounds
gsynth_ife_abs_coverage_AB=future_map(gsynth_ife_bootstrapped_abs_att_AB, compute_tot_coverage)

#SCDID PROCESS
scdid_results_AB=future_pmap(list(data_list, rep(list(id_var="entry"), length(data_list)),
                               rep(list(time_var="period"),length(data_list)),
                               rep(list(treat_indicator="treatperiod_0"), length(data_list)), 
                               rep(list(outcome_var="target"),length(data_list)),
                               rep(list(counterfac_var="counter_factual"), length(data_list)),
                               rep(list(pre_SDID = 0),length(data_list)),
                               rep(list(post_SDID = NULL),length(data_list)),
                               rep(list(nn_SDID = NULL),length(data_list)),
                               rep(list(scale_SDID = 100),length(data_list)),
                               rep(list(period_SDID = 30),length(data_list))) , estimate_scdid_series)

#get bootstrapped CIs, counterfactual effects
scdid_bootstrapped_abs_att_AB=future_pmap(list(scdid_results_AB ),compute_tot_se_jackknife)
#store gap plots
scdid_bootstrapped_abs_att_AB_plots=future_pmap(list(scdid_bootstrapped_abs_att_AB,
...
#compute MSE and MAE bu post period
scdid_abs_metric_byT_AB=future_pmap(list(scdid_results_AB, metric_str="both"),compute_avg_metric_per_t)
#compute overall MSE, MAE
scdid_abs_metric_AB=future_pmap(list(scdid_results_AB, metric_str="both"),compute_avg_metric)
#compute "coverage" -- not sure if that's exactly it, but the frac of time the true TE is in the bounds
scdid_abs_coverage_AB=future_map(scdid_bootstrapped_abs_att_AB, compute_tot_coverage)
...
#get bootstrapped CIs, counterfactual effects
gsynth_ife_EM_bootstrapped_abs_att_AB=future_pmap(list(gsynth_ife_EM_AB ),compute_tot_se_jackknife)
#store gap plots
gsynth_ife_EM_bootstrapped_abs_att_AB_plots=future_pmap(list(gsynth_ife_EM_bootstrapped_abs_att_AB),create_gap_ci_plot)
#compute MSE and MAE bu post period
gsynth_ife_EM_abs_metric_byT_AB=future_pmap(list(gsynth_ife_EM_AB, metric_str="both"),compute_avg_metric_per_t)
#compute overall MSE, MAE
gsynth_ife_EM_abs_metric_AB=future_pmap(list(gsynth_ife_EM_AB, metric_str="both"),compute_avg_metric)
#compute "coverage" -- not sure if that's exactly it, but the frac of time the true TE is in the bounds
gsynth_ife_EM_abs_coverage_AB=future_map(gsynth_ife_EM_bootstrapped_abs_att_AB, compute_tot_coverage)
...
#get bootstrapped CIs, counterfactual effects
gsynth_mc_bootstrapped_abs_att_AB=future_pmap(list(gsynth_mc_AB ),compute_tot_se_jackknife)
#store gap plots
gsynth_mc_bootstrapped_abs_att_AB_plots=future_pmap(list(gsynth_mc_bootstrapped_abs_att_AB),create_gap_ci_plot)
#compute MSE and MAE bu post period
gsynth_mc_abs_metric_byT_AB=future_pmap(list(gsynth_mc_AB, metric_str="both"),compute_avg_metric_per_t)
#compute overall MSE, MAE
gsynth_mc_abs_metric_AB=future_pmap(list(gsynth_mc_AB, metric_str="both"),compute_avg_metric)
#compute "coverage" -- not sure if that's exactly it, but the frac of time the true TE is in the bounds
gsynth_mc_abs_coverage_AB=future_map(gsynth_mc_bootstrapped_abs_att_AB, compute_tot_coverage)
...
#get bootstrapped CIs, counterfactual effects
causalimpact_bootstrapped_abs_att_AB=future_pmap(list(causalimpact_results_AB ),compute_tot_se_jackknife)
#store gap plots
causalimpact_bootstrapped_abs_att_AB_plots=future_pmap(list(causalimpact_bootstrapped_abs_att_AB,
...
#compute MSE and MAE bu post period
causalimpact_abs_metric_byT_AB=future_pmap(list(causalimpact_results_AB, metric_str="both"),compute_avg_metric_per_t)
#compute overall MSE, MAE
causalimpact_abs_metric_AB=future_pmap(list(causalimpact_results_AB, metric_str="both"),compute_avg_metric)
#compute "coverage" -- not sure if that's exactly it, but the frac of time the true TE is in the bounds
causalimpact_abs_coverage_AB=future_map(causalimpact_bootstrapped_abs_att_AB, compute_tot_coverage)
...
#get bootstrapped CIs, counterfactual effects
gsynth_ife_bootstrapped_abs_att_AA=future_pmap(list(gsynth_ife_AA ),compute_tot_se_jackknife)
#store gap plots
gsynth_ife_bootstrapped_abs_att_AA_plots=future_pmap(list(gsynth_ife_bootstrapped_abs_att_AA,
                                                          plot_title="Gsynth Mean ToT by Post Treat Period, Jackknife CI", plot_x_lab="Post Treat Period", plot_y_lab="Mean ToT"),create_gap_ci_plot)
#compute MSE and MAE bu post period
gsynth_ife_abs_metric_byT_AA=future_pmap(list(gsynth_ife_AA, metric_str="both"),compute_avg_metric_per_t)
#compute overall MSE, MAE
gsynth_ife_abs_metric_AA=future_pmap(list(gsynth_ife_AA, metric_str="both"),compute_avg_metric)
#compute "coverage" -- not sure if that's exactly it, but the frac of time the true TE is in the bounds
gsynth_ife_abs_coverage_AA=future_map(gsynth_ife_bootstrapped_abs_att_AA, compute_tot_coverage)


#SCDID PROCESS
scdid_results_AA=future_pmap(list(placebo_data_list, rep(list(id_var="entry"), length(placebo_data_list)),
                                  rep(list(time_var="period"),length(placebo_data_list)),
                                  rep(list(treat_indicator="treatperiod_0"), length(placebo_data_list)), 
                                  rep(list(outcome_var="target"),length(placebo_data_list)),
                                  rep(list(counterfac_var="counter_factual"), length(placebo_data_list)),
                                  rep(list(pre_SDID = 0),length(placebo_data_list)),
                                  rep(list(post_SDID = NULL),length(placebo_data_list)),
                                  rep(list(nn_SDID = NULL),length(placebo_data_list)),
                                  rep(list(scale_SDID = 100),length(placebo_data_list)),
                                  rep(list(period_SDID = 30),length(placebo_data_list))) , estimate_scdid_series)

#get bootstrapped CIs, counterfactual effects
scdid_bootstrapped_abs_att_AA=future_pmap(list(scdid_results_AA ),compute_tot_se_jackknife)
#store gap plots
scdid_bootstrapped_abs_att_AA_plots=future_pmap(list(scdid_bootstrapped_abs_att_AA,
                                                     plot_title="SCDID Mean ToT by Post Treat Period, Jackknife CI", plot_x_lab="Post Treat Period", plot_y_lab="Mean ToT"),create_gap_ci_plot)
#compute MSE and MAE bu post period
scdid_abs_metric_byT_AA=future_pmap(list(scdid_results_AA, metric_str="both"),compute_avg_metric_per_t)
#compute overall MSE, MAE
scdid_abs_metric_AA=future_pmap(list(scdid_results_AA, metric_str="both"),compute_avg_metric)
#compute "coverage" -- not sure if that's exactly it, but the frac of time the true TE is in the bounds
scdid_abs_coverage_AA=future_map(scdid_bootstrapped_abs_att_AA, compute_tot_coverage)
...
#get bootstrapped CIs, counterfactual effects
gsynth_ife_EM_bootstrapped_abs_att_AA=future_pmap(list(gsynth_ife_EM_AA ),compute_tot_se_jackknife)
#store gap plots
gsynth_ife_EM_bootstrapped_abs_att_AA_plots=future_pmap(list(gsynth_ife_EM_bootstrapped_abs_att_AA,
...
#compute MSE and MAE bu post period
gsynth_ife_EM_abs_metric_byT_AA=future_pmap(list(gsynth_ife_EM_AA, metric_str="both"),compute_avg_metric_per_t)
#compute overall MSE, MAE
gsynth_ife_EM_abs_metric_AA=future_pmap(list(gsynth_ife_EM_AA, metric_str="both"),compute_avg_metric)
#compute "coverage" -- not sure if that's exactly it, but the frac of time the true TE is in the bounds
gsynth_ife_EM_abs_coverage_AA=future_map(gsynth_ife_EM_bootstrapped_abs_att_AA, compute_tot_coverage)
...
#get bootstrapped CIs, counterfactual effects
gsynth_mc_bootstrapped_abs_att_AA=future_pmap(list(gsynth_mc_AA ),compute_tot_se_jackknife)
#store gap plots
gsynth_mc_bootstrapped_abs_att_AA_plots=future_pmap(list(gsynth_mc_bootstrapped_abs_att_AA,
...
#compute MSE and MAE bu post period
gsynth_mc_abs_metric_byT_AA=future_pmap(list(gsynth_mc_AA, metric_str="both"),compute_avg_metric_per_t)
#compute overall MSE, MAE
gsynth_mc_abs_metric_AA=future_pmap(list(gsynth_mc_AA, metric_str="both"),compute_avg_metric)
#compute "coverage" -- not sure if that's exactly it, but the frac of time the true TE is in the bounds
gsynth_mc_abs_coverage_AA=future_map(gsynth_mc_bootstrapped_abs_att_AA, compute_tot_coverage)
...
#get bootstrapped CIs, counterfactual effects
causalimpact_bootstrapped_abs_att_AA=future_pmap(list(causalimpact_results_AA ),compute_tot_se_jackknife)
#store gap plots
causalimpact_bootstrapped_abs_att_AA_plots=future_pmap(list(causalimpact_bootstrapped_abs_att_AA,
                                                            plot_title="Causal Impact Mean ToT by Post Treat Period, Jackknife CI", plot_x_lab="Post Treat Period", plot_y_lab="Mean ToT"),create_gap_ci_plot)
#compute MSE and MAE bu post period
causalimpact_abs_metric_byT_AA=future_pmap(list(causalimpact_results_AA, metric_str="both"),compute_avg_metric_per_t)
#compute overall MSE, MAE
causalimpact_abs_metric_AA=future_pmap(list(causalimpact_results_AA, metric_str="both"),compute_avg_metric)
#compute "coverage" -- not sure if that's exactly it, but the frac of time the true TE is in the bounds
causalimpact_abs_coverage_AA=future_map(causalimpact_bootstrapped_abs_att_AA, compute_tot_coverage)
...
#get bootstrapped CIs, counterfactual effects
placebo_ensemble_bootstrapped_abs_att_AB=future_pmap(list(placebo_ensemble_results ),compute_tot_se_jackknife)
#store gap plots
placebo_ensemble_bootstrapped_abs_att_AB_plots=future_pmap(list(placebo_ensemble_bootstrapped_abs_att_AB,
...
#compute MSE and MAE bu post period
placebo_ensemble_abs_metric_byT_AB=future_pmap(list(placebo_ensemble_results, metric_str="both"),compute_avg_metric_per_t)
#compute overall MSE, MAE
placebo_ensemble_abs_metric_AB=future_pmap(list(placebo_ensemble_results, metric_str="both"),compute_avg_metric)
#compute "coverage" -- not sure if that's exactly it, but the frac of time the true TE is in the bounds
placebo_ensemblee_abs_coverage_AB=future_map(placebo_ensemble_bootstrapped_abs_att_AB, compute_tot_coverage)
